...
import com.example.crypto24.api.ApiFactory.BASE_IMAGE_URL
import com.example.crypto24.utils.convertTimeStampToTime
...
data class CoinPriceInfo(
    ...
    fun getFormattedTime(): String? {
        return lastUpdate?.let { convertTimeStampToTime(it) }
    }
